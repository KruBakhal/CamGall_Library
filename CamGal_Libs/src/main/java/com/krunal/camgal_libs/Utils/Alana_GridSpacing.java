...
public class Alana_GridSpacing extends RecyclerView.ItemDecoration {

    // How to implement
    // <RecyclerView>.addItemDecoration(new Alana_GridSpacing(<spanCount>, <spacing>, true));

    private int spanCount;
    private int spacing;
    private boolean includeEdge;

    public Alana_GridSpacing(int spanCount, int spacing, boolean includeEdge) {
